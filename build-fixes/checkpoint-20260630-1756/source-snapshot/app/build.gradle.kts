...
val keystoreProps = Properties().apply {
    if (keystorePropsFile.exists()) {
        ...
        setProperty("storeFile", "tvbox-simple-release.keystore")
        setProperty("storePassword", "tvbox1234")
        setProperty("keyAlias", "tvboxsimple")
        setProperty("keyPassword", "tvbox1234")
    }
}
